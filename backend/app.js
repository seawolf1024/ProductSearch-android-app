// use http server
const http = require('http'); // If you're making an HTTP request
const https = require('https'); // If you're making an HTTPS request

// ebay token
const OAuthToken = require('./ebay_oauth_token.js');
const client_id = 'Zhanshan-csci570h-PRD-e7284ce84-b621a0b0';
const client_secret = 'PRD-7284ce84e17e-b3f0-4f7e-b8ae-1ced';
const OAuthTokenInstance = new OAuthToken(client_id, client_secret);
const axios = require('axios');

// mongoDB
const {MongoClient, ObjectId} = require('mongodb');
const client = new MongoClient('mongodb+srv://myaccount:mypassword@cluster0.qecoyl9.mongodb.net/?retryWrites=true&w=majority')
...
function getPhotosUrl(product_title){
    ...
    let apiKey = "AIzaSyA0d8ljBxvVXuhqC3oHYk3-TRdxbZY-orY";
    let searchEngineKey = "805eaf4b7b0d34890";
...
app.post('/getzipcodes', function(req, res){ // req.body = {"currZipcode": this.currZipcode}
    ...
    http.get(apiUrl, (response) => {
        ...
        response.on('end', () => {
            ...
            // console.log(data);
            // You can also parse the JSON data if needed
            try {
                const jsonData = JSON.parse(data);
